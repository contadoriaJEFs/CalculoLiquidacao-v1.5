...
function ativarGuia(nomeGuia) {
    ...
    // Montar a Guia 4 ao acessar a aba Diferenças
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================================
    // TERMO INICIAL MANUAL – CORREÇÃO FINAL
    // ============================================================
    document.querySelectorAll('#termoInicialDiferencas, #termoInicialDiferencas2').forEach(el => {
        if (el) {
            ...
            // Evento blur: normaliza e sincroniza os dois campos
    ...
    // Se a guia atual for "diferencas", montar a tabela
...
// =====================================================================
// FUNÇÃO sincronizarTermoInicial – CORRIGIDA (normalização apenas no blur)
// =====================================================================
...
// =====================================================================
// FUNÇÕES DE CÁLCULO (chamadas a partir do motor)
// =====================================================================
...
function exibirResultado(resultado, parametros) {
    ...
    // Armazenar memória globalmente para a Guia 4
...
// =====================================================================
// ALIAS E VARIÁVEIS GLOBAIS (para compatibilidade)
// =====================================================================
